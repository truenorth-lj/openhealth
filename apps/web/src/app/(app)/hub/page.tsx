...
const sections: { title: string; items: HubItem[] }[] = [
  {
    ...
    items: [
      ...
      { href: "/exercise", label: "運動記錄", icon: Activity, implemented: true },
      { href: "/workout", label: "重訓記錄", icon: Dumbbell, implemented: true, badge: "新" },
      ...
      { href: "/weight", label: "體重紀錄", icon: Scale, implemented: true },
      { href: "/steps", label: "步數紀錄", icon: Footprints, implemented: true },
